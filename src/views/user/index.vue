  ...
  <div class="user">
    ...
    <van-cell-group>
      ...
      <van-cell class="user-info" :border="false">
        <!-- 头像 -->
        <van-image :src="userInfo.portrait || 'https://img01.yzcdn.cn/vant/cat.jpeg'" width="50" height="50" round></van-image>
        <!-- 用户信息内容区域 -->
      ...
      <van-cell class="account-info">
        <van-grid :border="false">
          <van-grid-item>
            <span class="grid-item-value">441.20</span>
            <span>学习时长</span>
          </van-grid-item>
          <van-grid-item>
            <span class="grid-item-value">0</span>
            <span>钱包/勾豆</span>
          </van-grid-item>
          <van-grid-item>
            <span class="grid-item-value">0</span>
          ...
          <van-grid-item>
            <span class="grid-item-value">348</span>
            <span>学分</span>
          </van-grid-item>
        </van-grid>
      </van-cell>
